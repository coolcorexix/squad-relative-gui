...
export interface NewAddressWhitelistedEventObject {
  users: string[];
}
export type NewAddressWhitelistedEvent = TypedEvent<
  [string[]],
  NewAddressWhitelistedEventObject
>;
...
export interface NewLotteryRoundsEventObject {
  startLotteryRound: BigNumber;
  finalLotteryRound: BigNumber;
}
export type NewLotteryRoundsEvent = TypedEvent<
  [BigNumber, BigNumber],
  NewLotteryRoundsEventObject
>;
