...
export declare namespace TradingCompV1 {
...
export interface NewCompetitionStatusEventObject {
  status: number;
}
export type NewCompetitionStatusEvent = TypedEvent<
  [number],
  NewCompetitionStatusEventObject
>;
...
export interface TeamRewardsUpdateEventObject {
  teamId: BigNumber;
}
export type TeamRewardsUpdateEvent = TypedEvent<
  [BigNumber],
  TeamRewardsUpdateEventObject
>;
...
export interface UserUpdateMultipleEventObject {
  userAddresses: string[];
  rewardGroup: BigNumber;
}
export type UserUpdateMultipleEvent = TypedEvent<
  [string[], BigNumber],
  UserUpdateMultipleEventObject
>;

export type UserUpdateMultipleEventFilter =
  TypedEventFilter<UserUpdateMultipleEvent>;

export interface WinningTeamEventObject {
  teamId: BigNumber;
}
export type WinningTeamEvent = TypedEvent<[BigNumber], WinningTeamEventObject>;
...
export interface TradingCompetition extends BaseContract {
  ...
  functions: {
    ...
    viewRewardTeams(
      overrides?: CallOverrides
    ): Promise<[TradingCompV1.CompetitionRewardsStructOutput[]]>;
