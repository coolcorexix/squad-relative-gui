...
export interface SaleStatusUpdateEventObject {
  newStatus: number;
}
export type SaleStatusUpdateEvent = TypedEvent<
  [number],
  SaleStatusUpdateEventObject
>;

export type SaleStatusUpdateEventFilter =
  TypedEventFilter<SaleStatusUpdateEvent>;

export interface TicketsDistributedEventObject {
  user: string;
  numberTickets: BigNumber;
}
export type TicketsDistributedEvent = TypedEvent<
  [string, BigNumber],
  TicketsDistributedEventObject
>;
