...
import type { IfoV3, IfoV3Interface } from "../IfoV3";
...
const _abi = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "address",
        name: "_ifoPoolAddress",
        type: "address",
      },
      {
        internalType: "uint256",
        name: "_pointThreshold",
        type: "uint256",
      },
      {
        internalType: "address",
        name: "_admissionProfile",
        type: "address",
      },
    ],
    name: "initialize",
...
export class IfoV3__factory {
  static readonly abi = _abi;
  static createInterface(): IfoV3Interface {
    return new utils.Interface(_abi) as IfoV3Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IfoV3 {
    return new Contract(address, _abi, signerOrProvider) as IfoV3;
  }
}
