...
export interface TeamAddEventObject {
  teamId: BigNumber;
  teamName: string;
}
export type TeamAddEvent = TypedEvent<[BigNumber, string], TeamAddEventObject>;

export type TeamAddEventFilter = TypedEventFilter<TeamAddEvent>;

export interface TeamPointIncreaseEventObject {
  teamId: BigNumber;
...
export interface UserPauseEventObject {
  userAddress: string;
  teamId: BigNumber;
}
export type UserPauseEvent = TypedEvent<
  [string, BigNumber],
  UserPauseEventObject
>;

export type UserPauseEventFilter = TypedEventFilter<UserPauseEvent>;

export interface UserPointIncreaseEventObject {
  userAddress: string;
  numberPoints: BigNumber;
  campaignId: BigNumber;
}
export type UserPointIncreaseEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  UserPointIncreaseEventObject
>;

export type UserPointIncreaseEventFilter =
  TypedEventFilter<UserPointIncreaseEvent>;

export interface UserPointIncreaseMultipleEventObject {
